...
(global-unset-key (kbd "C-c c"))
(define-prefix-command 'start-map)
(define-prefix-command 'cool-map)
...
(define-key start-map (kbd "c") 'cool-map)
...
;; Cool Map
(define-key cool-map (kbd "c") 'clerk-show)
